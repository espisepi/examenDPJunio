...
CREATE TABLE `audits` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_to8xg4utgb99xurlyykcowlce` (`ticker`),
  KEY `UK_gxwhkpxlk17x0ynqohrlkjn86` (`moment`,`newspaper_id`,`admin_id`),
  KEY `FK_o8c5d9uic1ojof8rkdyk04ep1` (`admin_id`),
  KEY `FK_klsdxfllxpiu0qbbl3s4ba367` (`newspaper_id`),
  CONSTRAINT `FK_klsdxfllxpiu0qbbl3s4ba367` FOREIGN KEY (`newspaper_id`) REFERENCES `newspaper` (`id`),
  CONSTRAINT `FK_o8c5d9uic1ojof8rkdyk04ep1` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `audits` VALUES (116,0,'description1','\0',1,'2020-02-02 13:00:00','2020/02/02-xxxx','title1',71,81),(117,0,'description2','\0',2,'2020-02-02 13:48:00','2020/02/02-erty','title2',71,82),(118,0,'description3','\0',3,'2018-02-02 15:22:00','2018/02/02-puta','title3',72,81),(119,0,'description4','\0',1,'2020-02-02 16:32:00','2020/02/02-coño','title4',72,82),(120,0,'description5','\0',2,'2018-02-02 16:32:00','2018/02/02-zorra','title5',71,83);
...
-- Dump completed on 2018-06-25  2:01:49
